...
selected_features = ['type', 'City', 'condition ', 'room_number', 'Area', 'furniture ', 'total_floors', 'hasMamad ', 'hasElevator ']
...
pipe_preprocessing_model = Pipeline([
    ...
    ('model', ElasticNet(alpha=0.1))  # Change the value of alpha here
])
